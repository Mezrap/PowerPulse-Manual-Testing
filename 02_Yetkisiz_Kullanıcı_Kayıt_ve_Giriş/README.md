# Yetkisiz Kullanıcı – Kayıt ve Giriş
...
Bu modül, yetkisiz kullanıcının Sign In ve Sign Up işlemlerinin, form alanlarının doğrulanmasının ve kullanıcı varlığı kontrollerinin test edilmesini kapsamaktadır. Ayrıca kayıt ve giriş süreçlerinde karşılaşılan hataların doğrulanması ve ilgili bug raporlarının oluşturulması amaçlanmıştır.

---

## İçindekiler

2. Gereksinim Takip Matrisi – RTM – 002 [UA – SISU]

   2.1. Sign In Form İçeriği – CL – 005 [UA – SI]

        2.1.1. Sign In Form İçeriği – TC – 001 [UA – SI]

        2.1.2. Sign In Form İçeriği – TC – 002 [UA – SI]
...
| Alan | Değer |
|------|--------|
| Modül | Yetkisiz Kullanıcı – Kayıt ve Giriş |
| Modül Kodu | UA – SISU |
| Doküman Sayısı | 20 |
| RTM | 1 |
| Checklist | 2 |
